Function New-DmarcReportDomain {
    ...
    if(($DomainObj.records | Where-Object -Property Domain -Like "${dmarcDomain}._report._dmarc.${receivingDomain}" | Select-Object -ExpandProperty short_answers) -ne "v=DMARC1"){
        New-Record -zone $receivingDomain -Domain "${dmarcDomain}._report._dmarc.${receivingDomain}" -Type TXT -Answers "v=DMARC1"
    }
}
...
Function Set-DmarcRecord {
    ...
    Set-Record -zone $zone -domain "_dmarc.$Domain" -Type TXT -Answers ($DmarcRecord -join ";")
}